...
/***/ 13:
/*!*************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/store.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _vuexPersistedstate = _interopRequireDefault(__webpack_require__(/*! vuex-persistedstate */ 15));
var _store = _interopRequireDefault(__webpack_require__(/*! ./store/store.js */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 15:
/*!********************************************************************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/node_modules/vuex-persistedstate/dist/vuex-persistedstate.es.js ***!
  \********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 16:
/*!*******************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/store/store.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  mutations: {
    // 初始vuex
    MUT_INIT: function MUT_INIT(state) {
    ...
    // 赋值 mine
    MUT_MINE: function MUT_MINE(state, value) {
      state.mine = Object.assign({}, value);
    },
    MUT_COUNTCHAT: function MUT_COUNTCHAT(state, value) {
      state.countChat = value;
    },
    // 赋值 firends
    MUT_FRIENDS: function MUT_FRIENDS(state, value) {
      state.friends = value;
    },
    MUT_FRIENDS_PUSH: function MUT_FRIENDS_PUSH(state, value) {
      state.friends.push(value);
    },
    // 赋值 申请好友 标记数量
    MUT_APPLYCOUNT: function MUT_APPLYCOUNT(state, value) {
      state.applyCount = value;
    },
    // 赋值 applys
    MUT_APPLYS: function MUT_APPLYS(state, value) {
      state.applys = value;
    },
    // 添加 applys
    MUT_APPLYS_PUSH: function MUT_APPLYS_PUSH(state, value) {
      state.applys.push(value);
    },
    MUT_SEARCH_APPLY: function MUT_SEARCH_APPLY(state, value) {
      state.search_apply = Object.assign({}, value);
    },
    MUT_CHATTING: function MUT_CHATTING(state, value) {
      state.chatting = Object.assign({}, value);
    } },

  actions: {
    // 初始vuex
    ACT_INIT: function ACT_INIT(content) {
      content.commit('MUT_INIT');
    },
    ACT_COUNTCHAT: function ACT_COUNTCHAT(content, value) {
      content.commit('MUT_COUNTCHAT', value);
    },
    // 赋值 mine
    ACT_MINE: function ACT_MINE(content, value) {
      content.commit('MUT_MINE', value);
    },
    // 赋值 firends
    ACT_FRIENDS: function ACT_FRIENDS(content, value) {
      content.commit('MUT_FRIENDS', value);
    },

    ACT_FRIENDS_PUSH: function ACT_FRIENDS_PUSH(content, value) {
      content.commit('MUT_FRIENDS_PUSH', value);
    },
    // 赋值 申请好友 标记数量
    ACT_APPLYCOUNT: function ACT_APPLYCOUNT(content, value) {
      content.commit('MUT_APPLYCOUNT', value);
    },
    // 赋值 applys
    ACT_APPLYS: function ACT_APPLYS(content, value) {
      content.commit('MUT_APPLYS', value);
    },
    // 添加 applys
    ACT_APPLYS_PUSH: function ACT_APPLYS_PUSH(content, value) {
      content.commit('MUT_APPLYS_PUSH', value);
    },
    ACT_SEARCH_APPLY: function ACT_SEARCH_APPLY(content, value) {
      content.commit('MUT_SEARCH_APPLY', value);
    },
    ACT_CHATTING: function ACT_CHATTING(content, value) {
...
Login = /*#__PURE__*/function (_Base) {_inherits(Login, _Base);var _super = _createSuper(Login);function Login() {_classCallCheck(this, Login);return _super.apply(this, arguments);}_createClass(Login, [{ key: "loginFn",
    ...
    /**
       ...
       * @param {Object} _res
       */ }, { key: "init", value: function () {var _init = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(
      _res) {var self;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                self = this;
                /** 获取登陆者信息 */
                _res = _res.data[0];
                ...
                self.heartStart();
                // 处理好友申请 同意
                self.socketOn('addFriend', function (_) {
                  self.vm.ACT_FRIENDS_PUSH(_.data[0]);
                  // 手机震动
                  uni.vibrateLong();
                  _unit.default.playTim();
                  self.heartStart;
                ...
                // 收到好友申请
                self.socketOn('addApply', function (_) {
                  ...
                  self.heartStart();
                  // 设置 消息标记
                  if (_unit.default.readCount(self.vm.base.applys, self.vm.base.mine.apply_last_time, true)) {
                    self.vm.ACT_APPLYCOUNT(
                    String(_unit.default.readCount(self.vm.base.applys, self.vm.base.mine.apply_last_time, true)));

                    uni.setTabBarBadge({
                      index: 1,
                      text: String(_unit.default.readCount(self.vm.base.applys, self.vm.base.mine.apply_last_time, true)) });

                  }
                });
                self.socketOn('friend-chat', function (_) {
                  self.getFriendChat(self.vm.base.chatting, {
                    username: _res.username,
                    to: _.data },
                  function () {
    ...
    /**
                                                                                                                                                              * 获取好友消息记录
                                                                                                                                                              * @param { username } _res
                                                                                                                                                              */ }, { key: "getFriendChat", value: function getFriendChat(
    chatting, _res, callback) {
      var self = this;
      _api.default.getFriendChat({
        friend_uid: _res.username,
        uid: _res.to || '' }).

      then( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(r) {var _r;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                  _r = r[1].data;if (!(
                  _r.code == 200)) {_context2.next = 7;break;}_context2.next = 4;return (
                    _r.data.forEach(function (e) {
                      ...
                      _unit.default.updateList(chatting, e.uid, e.chatting[e.chatting.length - 1]);
                      self.socketOn('friend-' + e.uid, function (_) {
                        ...
                        then(function (res) {
                          ...
                          if (_res.code == 200) {
                            ...
                            _unit.default.updateList(chatting, e.uid, _res.data[0]);
                  ...
                  callback ? callback() : '';case 7:case "end":return _context2.stop();}}}, _callee2);}));return function (_x2) {return _ref.apply(this, arguments);};}());
    ...
    /**
       ...
       */ }, { key: "getFirends", value: function getFirends(
    _res) {
      var self = this;
      _api.default.getApply({
        friend_uid: _res.username,
        pass_state: 2,
        uid: '' }).
    ...
    /**
       * 获取好友申请
       * @param { friend_uid 用户自己的id } _res
       */ }, { key: "getApply", value: function getApply(
    _res) {
      var self = this;
      _api.default.getApply({
        friend_uid: _res.username,
      ...
      then(function (r) {
        ...
        if (_r.code == 200) {
          ...
          if (_unit.default.readCount(self.vm.base.applys, self.vm.base.mine.apply_last_time, true)) {
            ...
            console.log(String(_unit.default.readCount(self.vm.base.applys, self.vm.base.mine.apply_last_time, true)));
            uni.setTabBarBadge({
              index: 1,
              text: String(_unit.default.readCount(self.vm.base.applys, self.vm.base.mine.apply_last_time, true)) });
    ...
    } }]);return Login;}(_base.default);exports.default = Login;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 27:
/*!*****************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/base/base.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _uniSocket = _interopRequireDefault(__webpack_require__(/*! @hyoga/uni-socket.io */ 28));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}

var ip = 'ws://182.92.169.234:9527';
var socket = null;

var timeout = 3000;
var timeoutObj = null;var

Base = /*#__PURE__*/function () {
  function Base(vm) {_classCallCheck(this, Base);
    this.vm = vm;
  }_createClass(Base, [{ key: "openIO", value: function openIO()
    {
      socket = (0, _uniSocket.default)(ip, {
        transports: ['websocket', 'polling'] });

      socket.on('connect', function () {
        console.log(socket.id, '连接');
      });
    } }, { key: "socketEmit", value: function socketEmit(
    event, args) {
      socket.emit(event, args);
    } }, { key: "socketOn", value: function socketOn(
    event, callback) {
      socket.on(event, function (_) {
        callback(_);
      });
    } }, { key: "socketClose", value: function socketClose()
    {
      socket.close();
    } }, { key: "socketDisconnect", value: function socketDisconnect()
    {
      socket.disconnect();
    } }, { key: "heartReset", value: function heartReset()
    {
      clearTimeout(timeoutObj);
    } }, { key: "heartStart", value: function heartStart()
    {
      var self = this;
      self.heartReset();
    ...
    } }, { key: "getIp", value: function getIp()
    {
      return ip;
...
/***/ 28:
/*!************************************************************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/node_modules/@hyoga/uni-socket.io/dist/uni-socket.io.js ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 29:
/*!*****************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/unit/unit.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  /**
                                                                                                                      ...
                                                                                                                      */
  dateConvert: function dateConvert(args) {
    var reg = /Y{4}|M{1,4}|D{1,2}|h+|m{1,2}|s{1,2}/g;
    var newDate = new Date(Number(args.date));
    var _date = {
    ...
    return args.dateFormat.replace(reg, function (_) {
      return _date[_];
    });
  },
  // 数组分割成多个数组
  ...
  arrSum: function arrSum(arr, target) {
    var num = 0;
    for (var i = 0; i < arr.length; i++) {
      num += arr[target];
    }
  ...
  // 更新消息列表 最新展示
  updateList: function updateList(chatting, target, pary) {
  ...
  // 播放消息提示音
  playTim: function playTim() {
    var timAudio = uni.createInnerAudioContext();
  ...
  /**
      ...
      */
  chatCount: function chatCount(arr, lastT, pary) {
    var _arr = [];
    for (var i = 0; i < arr.length; i++) {
  ...
  readCount: function readCount(arr, lastT, isChatting) {
    var _arr = [];
    lastT = lastT ? lastT : '0';
...
/***/ 4:
/*!***************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/pages.json ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 54:
/*!***********************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/pages/mine/mine.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _base = _interopRequireDefault(__webpack_require__(/*! ../../base/base.js */ 27));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _createSuper(Derived) {return function () {var Super = _getPrototypeOf(Derived),result;if (_isNativeReflectConstruct()) {var NewTarget = _getPrototypeOf(this).constructor;result = Reflect.construct(Super, arguments, NewTarget);} else {result = Super.apply(this, arguments);}return _possibleConstructorReturn(this, result);};}function _possibleConstructorReturn(self, call) {if (call && (typeof call === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _isNativeReflectConstruct() {if (typeof Reflect === "undefined" || !Reflect.construct) return false;if (Reflect.construct.sham) return false;if (typeof Proxy === "function") return true;try {Date.prototype.toString.call(Reflect.construct(Date, [], function () {}));return true;} catch (e) {return false;}}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}var
Mine = /*#__PURE__*/function (_Base) {_inherits(Mine, _Base);var _super = _createSuper(Mine);function Mine() {_classCallCheck(this, Mine);return _super.apply(this, arguments);}_createClass(Mine, [{ key: "loginOut", value: function loginOut()
    {
      this.heartReset();
      // 重置vuex
      this.vm.ACT_INIT();
    ...
    } }]);return Mine;}(_base.default);exports.default = Mine;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 61:
/*!**********************************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/components/uni-icons/icons.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 8:
/*!***************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/api/api.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _http = _interopRequireDefault(__webpack_require__(/*! ../http/http.js */ 9));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =

{
  ...
  login: function login(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/user/login", 'POST', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
  ...
  upload: function upload(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/upload", 'POST', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
  ...
  /** 搜索用户
      * @param {uid} param
      */
  searchFriend: function searchFriend(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/user/searchFriend?uid=".concat(param.uid), 'GET', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
  ...
  addApply: function addApply(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/user/addApply", 'POST', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
  ...
  lookApply: function lookApply(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/user/lookApply", 'POST', {}, param).
      then(function (res) {
        resolve(res);
      }).
      catch(function (ret) {
  ...
  getApply: function getApply(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/user/getApply?friend_uid=".concat(param.friend_uid, "&pass_state=").concat(param.pass_state, "&uid=").concat(param.uid), 'GET', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
  ...
  setApply: function setApply(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/user/setApply", 'POST', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
  ...
  lookChat: function lookChat(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest('/chat/lookChat', 'POST', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
  ...
  getFriendChat: function getFriendChat(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/chat/getFriendChat", 'POST', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
  ...
  send: function send(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/chat/send", 'POST', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
  ...
  getMessage: function getMessage(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/chat/getMessage", 'GET', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
  ...
  getFriendChatting: function getFriendChatting(param) {
    return new Promise(function (resolve, reject) {
      _http.default.httpRequest("/chat/getFriendChatting", 'POST', {}, param).
      then(function (res) {
        return resolve(res);
      }).
      catch(function (ret) {
...
/***/ 9:
/*!*****************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/http/http.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; /**
                                                                                                      * 封装http请求
                                                                                                      * */
var ip = 'http://182.92.169.234:3000';
// const ip = 'http://localhost:3000'
var _default = {
  getIp: function getIp() {
    return ip;
  },
  httpRequest: function httpRequest(url, method, header, param) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: ip + url,
        method: method,
...
/***/ 90:
/*!**********************************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/pages/chatting/friend_chat.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _api = _interopRequireDefault(__webpack_require__(/*! ../../api/api.js */ 8));
var _unit = _interopRequireDefault(__webpack_require__(/*! ../../unit/unit.js */ 29));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _createSuper(Derived) {return function () {var Super = _getPrototypeOf(Derived),result;if (_isNativeReflectConstruct()) {var NewTarget = _getPrototypeOf(this).constructor;result = Reflect.construct(Super, arguments, NewTarget);} else {result = Super.apply(this, arguments);}return _possibleConstructorReturn(this, result);};}function _possibleConstructorReturn(self, call) {if (call && (typeof call === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _isNativeReflectConstruct() {if (typeof Reflect === "undefined" || !Reflect.construct) return false;if (Reflect.construct.sham) return false;if (typeof Proxy === "function") return true;try {Date.prototype.toString.call(Reflect.construct(Date, [], function () {}));return true;} catch (e) {return false;}}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}var
FriendChat = /*#__PURE__*/function (_Base) {_inherits(FriendChat, _Base);var _super = _createSuper(FriendChat);function FriendChat() {_classCallCheck(this, FriendChat);return _super.apply(this, arguments);}_createClass(FriendChat, [{ key: "init",
    /** 初始 */value: function init(
    ops) {
      var self = this;
    ...
    } }, { key: "initSet", value: function initSet(
    ops) {
      var self = this;
    ...
    /** 自动滚底 */ }, { key: "scrollBottom", value: function scrollBottom()
    {
      var self = this;
    ...
    /** 判断 数组 相邻数据是否超过 5分钟 */ }, { key: "difference", value: function difference(
    _now, arg) {
    ...
    /** 下拉加载更多 */ }, { key: "reStart", value: function reStart(
    e) {
      var self = this;
      if (self.vm.hasNo) {
    ...
    // 隐藏输入内容卡 （表情卡 更多类卡）
  }, { key: "hideCard", value: function hideCard() {
    ...
    chatting, _res, callback) {
      ...
      then( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(r) {var _r;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                  _r = r[1].data;if (!(
                  _r.code == 200)) {_context.next = 7;break;}_context.next = 4;return (
                    _r.data.forEach(function (e) {
                  ...
                  callback ? callback() : '';case 7:case "end":return _context.stop();}}}, _callee);}));return function (_x) {return _ref.apply(this, arguments);};}());


    }
    /** 发送消息 */ }, { key: "send", value: function send(
    param) {
      var self = this;
      ...
      then(function (res) {
        ...
        if (_res.code == 200) {
          ...
          then(function (r) {
            ...
            // 发送消息 更新列表显示 最新消息内容
            _unit.default.updateList(self.vm.base.chatting, self.vm.list.to, _r.data[0]);
            self.vm.ACT_CHATTING(self.vm.base.chatting);
            self.scrollBottom();
          });
          self.vm.$nextTick(function () {
    ...
    /** 获取更多消息记录 */ }, { key: "getFriendChatting", value: function getFriendChatting(
    _res) {var _arguments = arguments;
      var self = this;
      ...
      then(function (r) {
        ...
        if (_r.code == 200) {
          ...
          _r.data.reduce(self.difference.bind(self.vm, _arguments));
          self.vm.now = {}[(
          _r.data[_r.data.length - 1], self.vm.chatList[0])] = [_r.data[_r.data.length - 1], self.vm.chatList[0]].reduce(self.difference.bind(self.vm, _arguments));
    ...
    } }, { key: "lookChat", value: function lookChat(
    param) {
      var self = this;
      _api.default.lookChat(param).
      then(function (res) {
        var _r = res[1].data;
        if (_r.code == 200) {
          var chatting = self.vm.base.chatting;
          var target = param.friend_uid;
          chatting['friend-' + target].last_time = param.last_time;
          chatting['friend-' + target].chatCount = _unit.default.chatCount(chatting['friend-' + target].chatting, chatting['friend-' + target].last_time, target);
          self.vm.ACT_CHATTING(chatting);
        }
      });
    } }]);return FriendChat;}(_base.default);exports.default = FriendChat;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 96:
/*!**********************************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/components/uni-popup/popup.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 97:
/*!************************************************************************!*\
  !*** E:/hl-project/聊天直播/uni-app-h5-02/components/uni-popup/message.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
